        ...
        <div className="container pt-24 px-4 sm:px-8 mx-auto">
            ...
            <div className="flex flex-col justify-center items-start text-center md:text-left">
              ...
              <div className="mt-8 flex items-center text-sm text-muted-foreground">
                <div className="flex -space-x-2 mr-3">
                  {[1, 2, 3].map((i) => (
                      <div key={i} className="w-8 h-8 rounded-full bg-muted-foreground/20 flex items-center justify-center border-2 border-background">
                        {i}
                      </div>
                  ))}
                </div>
              ...
              <div className="bg-card border rounded-2xl shadow-xl p-4 w-full max-w-md animate-float">
                ...
                <div className="mt-4 p-3 bg-muted/50 rounded-lg">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="ml-2 text-xs font-medium text-muted-foreground">Processing audio...</span>
                  </div>
          ...
          <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Multiple Languages", desc: "Support for over 20 languages with specialized language models" },
              { title: "Fast Processing", desc: "Convert audio to text in a fraction of the time" }
            ].map((feature, i) => (
                <div key={i} className="bg-card border rounded-xl p-6 hover:shadow-md transition-all duration-300">
                  <div className="w-10 h-10 rounded-full speekly-gradient flex items-center justify-center mb-4">
