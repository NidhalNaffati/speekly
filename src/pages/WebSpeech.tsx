        ...
        <div className="min-h-screen bg-background">
            <div className="container mx-auto pt-24 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-center text-muted-foreground mb-8 animate-fade-in"
                       style={{animationDelay: "0.1s"}}>
                        Use your browser's built-in speech recognition to transcribe your voice in real-time.
                    </p>
                    <div
                        className="bg-card rounded-lg shadow-lg mb-12 p-6 border border-l-4 border-l-speekly-blue animate-fade-in"
                        style={{animationDelay: "0.2s"}}>
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            <div className="flex-1">
                                <h2 className="text-xl font-bold mb-2">Web Speech vs Electron App</h2>
                                <p className="text-muted-foreground mb-4">
                                    The Web Speech API provides convenient speech recognition but has limitations in
                                    accuracy and language support.
                                    For professional transcription with up to 25% higher accuracy and offline
                                    capabilities, try our dedicated Electron app.
                                </p>
